...
namespace lua::native
{
	...
	static void LUA_NATIVE_AUDIO_PLAY_PED_AUDIO_EVENT_ANIM(Ped pedHandle, sol::stack_object audioEvent)
	{
		AUDIO::PLAY_PED_AUDIO_EVENT_ANIM(pedHandle, audioEvent.is<const char*>() ? audioEvent.as<const char*>() : nullptr);
	}
	...
	static void LUA_NATIVE_AUDIO_FORCE_VEHICLE_ENGINE_SYNTH_(Vehicle vehicle, bool force)
	{
		AUDIO::_FORCE_VEHICLE_ENGINE_SYNTH(vehicle, force);
	}
	...
	static void LUA_NATIVE_AUDIO_SET_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE(Hash interiorNameHash, int roomIndex, int doorIndex, sol::stack_object newPortalSettingsName)
	{
		AUDIO::SET_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE(interiorNameHash, roomIndex, doorIndex, newPortalSettingsName.is<const char*>() ? newPortalSettingsName.as<const char*>() : nullptr);
	}
	...
	static void LUA_NATIVE_AUDIO_REMOVE_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE(Hash interiorNameHash, int roomIndex, int doorIndex)
	{
		AUDIO::REMOVE_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE(interiorNameHash, roomIndex, doorIndex);
	}
	...
	void init_native_binding_AUDIO(sol::state& L)
	{
		...
		AUDIO.set_function("PLAY_PED_AUDIO_EVENT_ANIM", LUA_NATIVE_AUDIO_PLAY_PED_AUDIO_EVENT_ANIM);
		...
		AUDIO.set_function("FORCE_VEHICLE_ENGINE_SYNTH_", LUA_NATIVE_AUDIO_FORCE_VEHICLE_ENGINE_SYNTH_);
		...
		AUDIO.set_function("SET_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE", LUA_NATIVE_AUDIO_SET_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE);
		AUDIO.set_function("REMOVE_PORTAL_SETTINGS_OVERRIDE", LUA_NATIVE_AUDIO_REMOVE_PORTAL_SETTINGS_OVERRIDE);
		AUDIO.set_function("REMOVE_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE", LUA_NATIVE_AUDIO_REMOVE_INDIVIDUAL_PORTAL_SETTINGS_OVERRIDE);
