...
namespace lua::native
{
	...
	static int LUA_NATIVE_CUTSCENE_GET_CUTSCENE_PLAY_TIME()
	{
		auto retval = CUTSCENE::GET_CUTSCENE_PLAY_TIME();
		return retval;
	}
	...
	void init_native_binding_CUTSCENE(sol::state& L)
	{
		...
		CUTSCENE.set_function("GET_CUTSCENE_PLAY_TIME", LUA_NATIVE_CUTSCENE_GET_CUTSCENE_PLAY_TIME);
