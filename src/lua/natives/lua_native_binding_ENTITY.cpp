...
namespace lua::native
{
	...
	static void LUA_NATIVE_ENTITY_SET_ENTITY_INVINCIBLE(Entity entity, bool toggle, bool dontResetOnCleanup)
	{
		ENTITY::SET_ENTITY_INVINCIBLE(entity, toggle, dontResetOnCleanup);
	}
	...
	static void LUA_NATIVE_ENTITY_SET_ENTITY_PROOFS(Entity entity, bool bulletProof, bool fireProof, bool explosionProof, bool collisionProof, bool meleeProof, bool steamProof, bool dontResetOnCleanup, bool waterProof)
	{
		ENTITY::SET_ENTITY_PROOFS(entity, bulletProof, fireProof, explosionProof, collisionProof, meleeProof, steamProof, dontResetOnCleanup, waterProof);
	}
	...
	static void LUA_NATIVE_ENTITY_SET_ENTITY_NO_COLLISION_WITH_NETWORKED_ENTITY_(Entity entity1, Entity entity2)
	{
		ENTITY::_SET_ENTITY_NO_COLLISION_WITH_NETWORKED_ENTITY(entity1, entity2);
	}
	...
	void init_native_binding_ENTITY(sol::state& L)
	{
		...
		ENTITY.set_function("SET_ENTITY_NO_COLLISION_WITH_NETWORKED_ENTITY_", LUA_NATIVE_ENTITY_SET_ENTITY_NO_COLLISION_WITH_NETWORKED_ENTITY_);
