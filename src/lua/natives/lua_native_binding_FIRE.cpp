...
namespace lua::native
{
	...
	static void LUA_NATIVE_FIRE_NETWORK_EXPECT_EXPLOSION_EVENTS_FOR_PLAYER_(bool expect, Player player)
	{
		FIRE::_NETWORK_EXPECT_EXPLOSION_EVENTS_FOR_PLAYER(expect, player);
	}

	static int LUA_NATIVE_FIRE_GET_MAXIMUM_NUMBER_OF_WATER_CANNONS_()
	{
		auto retval = FIRE::_GET_MAXIMUM_NUMBER_OF_WATER_CANNONS();
		return retval;
	}

	static Vector3 LUA_NATIVE_FIRE_GET_WATER_CANNON_COORDS_(int index)
	{
		auto retval = FIRE::_GET_WATER_CANNON_COORDS(index);
		return retval;
	}
	...
	void init_native_binding_FIRE(sol::state& L)
	{
		...
		FIRE.set_function("NETWORK_EXPECT_EXPLOSION_EVENTS_FOR_PLAYER_", LUA_NATIVE_FIRE_NETWORK_EXPECT_EXPLOSION_EVENTS_FOR_PLAYER_);
		FIRE.set_function("GET_MAXIMUM_NUMBER_OF_WATER_CANNONS_", LUA_NATIVE_FIRE_GET_MAXIMUM_NUMBER_OF_WATER_CANNONS_);
		FIRE.set_function("GET_WATER_CANNON_COORDS_", LUA_NATIVE_FIRE_GET_WATER_CANNON_COORDS_);
	}
}
