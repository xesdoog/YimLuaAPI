...
namespace lua::native
{
	...
	static std::tuple<bool, int> LUA_NATIVE_GRAPHICS_HAS_SCALEFORM_MOVIE_NAMED_LOADED_(int scaleformHandle, sol::stack_object scaleformName)
	{
		std::tuple<bool, int> return_values;
		std::get<0>(return_values) = (bool)GRAPHICS::_HAS_SCALEFORM_MOVIE_NAMED_LOADED(&scaleformHandle, scaleformName.is<const char*>() ? scaleformName.as<const char*>() : nullptr);
		std::get<1>(return_values) = scaleformHandle;
	...
	static void LUA_NATIVE_GRAPHICS_SET_SCALEFORM_MOVIE_NAMED_AS_NO_LONGER_NEEDED_(int scaleformHandle, sol::stack_object scaleformName)
	{
		GRAPHICS::_SET_SCALEFORM_MOVIE_NAMED_AS_NO_LONGER_NEEDED(scaleformHandle, scaleformName.is<const char*>() ? scaleformName.as<const char*>() : nullptr);
	}
	...
	static Any LUA_NATIVE_GRAPHICS_SET_TV_CHANNEL_PLAYLIST_DIRTY_(int tvChannel, bool p1)
	{
		auto retval = GRAPHICS::_SET_TV_CHANNEL_PLAYLIST_DIRTY(tvChannel, p1);
		return retval;
	}
	...
	void init_native_binding_GRAPHICS(sol::state& L)
	{
		...
		GRAPHICS.set_function("HAS_SCALEFORM_MOVIE_NAMED_LOADED_", LUA_NATIVE_GRAPHICS_HAS_SCALEFORM_MOVIE_NAMED_LOADED_);
		...
		GRAPHICS.set_function("SET_SCALEFORM_MOVIE_NAMED_AS_NO_LONGER_NEEDED_", LUA_NATIVE_GRAPHICS_SET_SCALEFORM_MOVIE_NAMED_AS_NO_LONGER_NEEDED_);
