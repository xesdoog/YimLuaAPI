...
namespace lua::native
{
	...
	static void LUA_NATIVE_HUD_SHOW_PURCHASE_INSTRUCTIONAL_BUTTON_(bool toggle)
	{
		HUD::_SHOW_PURCHASE_INSTRUCTIONAL_BUTTON(toggle);
	}
	...
	static int LUA_NATIVE_HUD_GET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE()
	{
		auto retval = HUD::GET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE();
		return retval;
	}

	static void LUA_NATIVE_HUD_SET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE(int mode)
	{
		HUD::SET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE(mode);
	}
	...
	static void LUA_NATIVE_HUD_SET_FAKE_GPS_PLAYER_POSITION_THIS_FRAME(float x, float y, float z)
	{
		HUD::SET_FAKE_GPS_PLAYER_POSITION_THIS_FRAME(x, y, z);
	}
	...
	static void LUA_NATIVE_HUD_SET_MINIMAP_BACKGROUND_HIDDEN(bool toggle)
	{
		HUD::SET_MINIMAP_BACKGROUND_HIDDEN(toggle);
	}
	...
	static bool LUA_NATIVE_HUD_IS_HUD_COMPONENT_HIDDEN_THIS_FRAME(int id)
	{
		auto retval = (bool)HUD::IS_HUD_COMPONENT_HIDDEN_THIS_FRAME(id);
		return retval;
	}
	...
	void init_native_binding_HUD(sol::state& L)
	{
		...
		HUD.set_function("SHOW_PURCHASE_INSTRUCTIONAL_BUTTON_", LUA_NATIVE_HUD_SHOW_PURCHASE_INSTRUCTIONAL_BUTTON_);
		...
		HUD.set_function("GET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE", LUA_NATIVE_HUD_GET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE);
		HUD.set_function("SET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE", LUA_NATIVE_HUD_SET_WAYPOINT_CLEAR_ON_ARRIVAL_MODE);
		...
		HUD.set_function("SET_MINIMAP_BACKGROUND_HIDDEN", LUA_NATIVE_HUD_SET_MINIMAP_BACKGROUND_HIDDEN);
		...
		HUD.set_function("IS_HUD_COMPONENT_HIDDEN_THIS_FRAME", LUA_NATIVE_HUD_IS_HUD_COMPONENT_HIDDEN_THIS_FRAME);
