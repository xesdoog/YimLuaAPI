...
namespace lua::native
{
	...
	static bool LUA_NATIVE_NETSHOPPING_NET_GAMESERVER_CHECKOUT_PENDING(int transactionId)
	{
		auto retval = (bool)NETSHOPPING::NET_GAMESERVER_CHECKOUT_PENDING(transactionId);
		return retval;
	}
	...
	void init_native_binding_NETSHOPPING(sol::state& L)
	{
		...
		NETSHOPPING.set_function("NET_GAMESERVER_CHECKOUT_PENDING", LUA_NATIVE_NETSHOPPING_NET_GAMESERVER_CHECKOUT_PENDING);
