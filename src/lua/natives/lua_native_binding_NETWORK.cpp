...
namespace lua::native
{
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_MULTIPLAYER_CROSSPLAY_NOT_ALLOWED_()
	{
		auto retval = (bool)NETWORK::_NETWORK_MULTIPLAYER_CROSSPLAY_NOT_ALLOWED();
		return retval;
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_CHECK_CAN_ACCESS_AND_ALERT()
	{
		auto retval = (bool)NETWORK::NETWORK_CHECK_CAN_ACCESS_AND_ALERT();
		return retval;
	}

	static const char* LUA_NATIVE_NETWORK_NETWORK_GET_ACCESS_CODE_LABEL_HEADING_(int accessCode)
	{
		auto retval = NETWORK::_NETWORK_GET_ACCESS_CODE_LABEL_HEADING(accessCode);
		return retval;
	}

	static const char* LUA_NATIVE_NETWORK_NETWORK_GET_ACCESS_CODE_LABEL_BODY_(int accessCode)
	{
		auto retval = NETWORK::_NETWORK_GET_ACCESS_CODE_LABEL_BODY(accessCode);
		return retval;
	}
	...
	static const char* LUA_NATIVE_NETWORK_NETWORK_INVITE_GET_JOIN_FAIL_REASON_()
	{
		auto retval = NETWORK::_NETWORK_INVITE_GET_JOIN_FAIL_REASON();
		return retval;
	}

	static void LUA_NATIVE_NETWORK_NETWORK_INVITE_CLEAR_JOIN_FAIL_REASON_()
	{
		NETWORK::_NETWORK_INVITE_CLEAR_JOIN_FAIL_REASON();
	}
	...
	static int LUA_NATIVE_NETWORK_NETWORK_GET_HOST_BROADCAST_DATA_SIZE_UNSYNCED_(Hash scriptNameHash, int instance, Hash positionHash, int handlerNum)
	{
		auto retval = NETWORK::_NETWORK_GET_HOST_BROADCAST_DATA_SIZE_UNSYNCED(scriptNameHash, instance, positionHash, handlerNum);
		return retval;
	}

	static int LUA_NATIVE_NETWORK_NETWORK_GET_PLAYER_BROADCAST_DATA_SIZE_UNSYNCED_(Hash scriptNameHash, int instance, Hash positionHash, int handlerNum)
	{
		auto retval = NETWORK::_NETWORK_GET_PLAYER_BROADCAST_DATA_SIZE_UNSYNCED(scriptNameHash, instance, positionHash, handlerNum);
		return retval;
	}

	static int LUA_NATIVE_NETWORK_NETWORK_GET_BROADCAST_DATA_HOST_UPDATE_SIZE_(Hash scriptNameHash, int instance, Hash positionHash, int handlerNum)
	{
		auto retval = NETWORK::_NETWORK_GET_BROADCAST_DATA_HOST_UPDATE_SIZE(scriptNameHash, instance, positionHash, handlerNum);
		return retval;
	}

	static int LUA_NATIVE_NETWORK_NETWORK_GET_BROADCAST_DATA_PLAYER_UPDATE_SIZE_(Hash scriptNameHash, int instance, Hash positionHash, int handlerNum)
	{
		auto retval = NETWORK::_NETWORK_GET_BROADCAST_DATA_PLAYER_UPDATE_SIZE(scriptNameHash, instance, positionHash, handlerNum);
		return retval;
	}
	...
	static const char* LUA_NATIVE_NETWORK_NETWORK_LOAD_GAMER_DISPLAY_NAME_(uintptr_t gamerHandle)
	{
		auto retval = NETWORK::_NETWORK_LOAD_GAMER_DISPLAY_NAME((Any*)gamerHandle);
		return retval;
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_PERMISSION_(int communicationType)
	{
		auto retval = (bool)NETWORK::_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_PERMISSION(communicationType);
		return retval;
	}

	static bool LUA_NATIVE_NETWORK_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_SETTINGS_ENABLED_(int communicationType)
	{
		auto retval = (bool)NETWORK::_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_SETTINGS_ENABLED(communicationType);
		return retval;
	}
	...
	static int LUA_NATIVE_NETWORK_NETWORK_GET_COMMUNICATION_GROUP_DEFAULT_FLAGS_(int communicationType)
	{
		auto retval = NETWORK::_NETWORK_GET_COMMUNICATION_GROUP_DEFAULT_FLAGS(communicationType);
		return retval;
	}

	static int LUA_NATIVE_NETWORK_NETWORK_GET_COMMUNICATION_GROUP_VALUE_(int communicationType)
	{
		auto retval = NETWORK::_NETWORK_GET_COMMUNICATION_GROUP_VALUE(communicationType);
		return retval;
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE_(int checkType, uintptr_t gamerHandle)
	{
		auto retval = (bool)NETWORK::_NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE(checkType, (Any*)gamerHandle);
		return retval;
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_CAN_TEXT_FROM_GAMER_BE_VIEWED_(uintptr_t gamerHandle)
	{
		auto retval = (bool)NETWORK::_NETWORK_CAN_TEXT_FROM_GAMER_BE_VIEWED((Any*)gamerHandle);
		return retval;
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_SET_TUTORIAL_SPECIAL_SESSION_(bool toggle)
	{
		NETWORK::_NETWORK_SET_TUTORIAL_SPECIAL_SESSION(toggle);
	}

	static bool LUA_NATIVE_NETWORK_NETWORK_IS_SPECIAL_TUTORIAL_SESSION_()
	{
		auto retval = (bool)NETWORK::_NETWORK_IS_SPECIAL_TUTORIAL_SESSION();
		return retval;
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_SET_TASK_CUTSCENE_INSCOPE_MULTIPLER(float multiplier)
	{
		NETWORK::NETWORK_SET_TASK_CUTSCENE_INSCOPE_MULTIPLER(multiplier);
	}

	static void LUA_NATIVE_NETWORK_NETWORK_HIDE_ENTITY_IN_TUTORIAL_SESSION_(int netHandle, bool hide)
	{
		NETWORK::_NETWORK_HIDE_ENTITY_IN_TUTORIAL_SESSION(netHandle, hide);
	}
	...
	static void LUA_NATIVE_NETWORK_SET_FREEMODE_REPORT_DATA_(uintptr_t gamerHandle, uintptr_t reportData)
	{
		NETWORK::_SET_FREEMODE_REPORT_DATA((Any*)gamerHandle, (Any*)reportData);
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_CLEAR_CLOCK_SYNC_TIME_OVERRIDE_(bool startGlobalTransition, int transitionTime)
	{
		NETWORK::_NETWORK_CLEAR_CLOCK_SYNC_TIME_OVERRIDE(startGlobalTransition, transitionTime);
	}

	static void LUA_NATIVE_NETWORK_NETWORK_SYNC_CLOCK_TIME_OVERRIDE()
	{
		NETWORK::NETWORK_SYNC_CLOCK_TIME_OVERRIDE();
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_SET_TUNABLES_REGISTRATION_CONTEXTS_(uintptr_t tunableContextData)
	{
		NETWORK::_NETWORK_SET_TUNABLES_REGISTRATION_CONTEXTS((Any*)tunableContextData);
	}

	static void LUA_NATIVE_NETWORK_NETWORK_CLEAR_TUNABLES_REGISTRATION_CONTEXTS_()
	{
		NETWORK::_NETWORK_CLEAR_TUNABLES_REGISTRATION_CONTEXTS();
	}

	static bool LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_BOOL_(Hash tunableName, bool defaultValue)
	{
		auto retval = (bool)NETWORK::_NETWORK_GET_TUNABLES_REGISTRATION_BOOL(tunableName, defaultValue);
		return retval;
	}

	static int LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_INT_(Hash tunableName, int defaultValue)
	{
		auto retval = NETWORK::_NETWORK_GET_TUNABLES_REGISTRATION_INT(tunableName, defaultValue);
		return retval;
	}

	static float LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_FLOAT_(Hash tunableName, float defaultValue)
	{
		auto retval = NETWORK::_NETWORK_GET_TUNABLES_REGISTRATION_FLOAT(tunableName, defaultValue);
		return retval;
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_TRIGGER_DAMAGE_EVENT_FOR_ZERO_PED_DAMAGE_(Entity entity, bool trigger)
	{
		NETWORK::_NETWORK_TRIGGER_DAMAGE_EVENT_FOR_ZERO_PED_DAMAGE(entity, trigger);
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_SET_IGNORE_VEHICLE_RAMMED_BY_NON_VEHICLE_(bool toggle)
	{
		NETWORK::_NETWORK_SET_IGNORE_VEHICLE_RAMMED_BY_NON_VEHICLE(toggle);
	}
	...
	static const char* LUA_NATIVE_NETWORK_UGC_GET_CONTENT_DESCRIPTION(int index)
	{
		auto retval = NETWORK::UGC_GET_CONTENT_DESCRIPTION(index);
		return retval;
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_HAS_ROS_PRIVILEGE_REPORTING_()
	{
		auto retval = (bool)NETWORK::_NETWORK_HAS_ROS_PRIVILEGE_REPORTING();
		return retval;
	}
	...
	static void LUA_NATIVE_NETWORK_NETWORK_GET_DUMP_OF_ASSET_VERIFIER_(uintptr_t p0)
	{
		NETWORK::_NETWORK_GET_DUMP_OF_ASSET_VERIFIER((Any*)p0);
	}
	...
	static bool LUA_NATIVE_NETWORK_NETWORK_HAS_SC_MEMBERSHIP()
	{
		auto retval = (bool)NETWORK::NETWORK_HAS_SC_MEMBERSHIP();
		return retval;
	}
	...
	static int LUA_NATIVE_NETWORK_NETWORK_GET_GAME_RESTART_REASON_()
	{
		auto retval = NETWORK::_NETWORK_GET_GAME_RESTART_REASON();
		return retval;
	}

	static void LUA_NATIVE_NETWORK_NETWORK_CONFIRM_GAME_RESTART_()
	{
		NETWORK::_NETWORK_CONFIRM_GAME_RESTART();
	}

	static const char* LUA_NATIVE_NETWORK_NETWORK_GET_GAME_RESTART_REASON_MESSAGE_LABEL_()
	{
		auto retval = NETWORK::_NETWORK_GET_GAME_RESTART_REASON_MESSAGE_LABEL();
		return retval;
	}

	static const char* LUA_NATIVE_NETWORK_NETWORK_GET_BATTLEYE_ERROR_MESSAGE_LABEL_(int errorCode)
	{
		auto retval = NETWORK::_NETWORK_GET_BATTLEYE_ERROR_MESSAGE_LABEL(errorCode);
		return retval;
	}
	...
	void init_native_binding_NETWORK(sol::state& L)
	{
		...
		NETWORK.set_function("NETWORK_MULTIPLAYER_CROSSPLAY_NOT_ALLOWED_", LUA_NATIVE_NETWORK_NETWORK_MULTIPLAYER_CROSSPLAY_NOT_ALLOWED_);
		...
		NETWORK.set_function("NETWORK_CHECK_CAN_ACCESS_AND_ALERT", LUA_NATIVE_NETWORK_NETWORK_CHECK_CAN_ACCESS_AND_ALERT);
		NETWORK.set_function("NETWORK_GET_ACCESS_CODE_LABEL_HEADING_", LUA_NATIVE_NETWORK_NETWORK_GET_ACCESS_CODE_LABEL_HEADING_);
		NETWORK.set_function("NETWORK_GET_ACCESS_CODE_LABEL_BODY_", LUA_NATIVE_NETWORK_NETWORK_GET_ACCESS_CODE_LABEL_BODY_);
		...
		NETWORK.set_function("NETWORK_INVITE_GET_JOIN_FAIL_REASON_", LUA_NATIVE_NETWORK_NETWORK_INVITE_GET_JOIN_FAIL_REASON_);
		NETWORK.set_function("NETWORK_INVITE_CLEAR_JOIN_FAIL_REASON_", LUA_NATIVE_NETWORK_NETWORK_INVITE_CLEAR_JOIN_FAIL_REASON_);
		...
		NETWORK.set_function("NETWORK_GET_HOST_BROADCAST_DATA_SIZE_UNSYNCED_", LUA_NATIVE_NETWORK_NETWORK_GET_HOST_BROADCAST_DATA_SIZE_UNSYNCED_);
		NETWORK.set_function("NETWORK_GET_PLAYER_BROADCAST_DATA_SIZE_UNSYNCED_", LUA_NATIVE_NETWORK_NETWORK_GET_PLAYER_BROADCAST_DATA_SIZE_UNSYNCED_);
		NETWORK.set_function("NETWORK_GET_BROADCAST_DATA_HOST_UPDATE_SIZE_", LUA_NATIVE_NETWORK_NETWORK_GET_BROADCAST_DATA_HOST_UPDATE_SIZE_);
		NETWORK.set_function("NETWORK_GET_BROADCAST_DATA_PLAYER_UPDATE_SIZE_", LUA_NATIVE_NETWORK_NETWORK_GET_BROADCAST_DATA_PLAYER_UPDATE_SIZE_);
		...
		NETWORK.set_function("NETWORK_LOAD_GAMER_DISPLAY_NAME_", LUA_NATIVE_NETWORK_NETWORK_LOAD_GAMER_DISPLAY_NAME_);
		...
		NETWORK.set_function("NETWORK_DOES_COMMUNICATION_GROUP_HAVE_PERMISSION_", LUA_NATIVE_NETWORK_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_PERMISSION_);
		NETWORK.set_function("NETWORK_DOES_COMMUNICATION_GROUP_HAVE_SETTINGS_ENABLED_", LUA_NATIVE_NETWORK_NETWORK_DOES_COMMUNICATION_GROUP_HAVE_SETTINGS_ENABLED_);
		NETWORK.set_function("NETWORK_GET_COMMUNICATION_GROUP_FLAGS_", LUA_NATIVE_NETWORK_NETWORK_GET_COMMUNICATION_GROUP_FLAGS_);
		NETWORK.set_function("NETWORK_GET_COMMUNICATION_GROUP_DEFAULT_FLAGS_", LUA_NATIVE_NETWORK_NETWORK_GET_COMMUNICATION_GROUP_DEFAULT_FLAGS_);
		NETWORK.set_function("NETWORK_GET_COMMUNICATION_GROUP_VALUE_", LUA_NATIVE_NETWORK_NETWORK_GET_COMMUNICATION_GROUP_VALUE_);
		NETWORK.set_function("NETWORK_SET_COMMUNICATION_GROUP_FLAGS_", LUA_NATIVE_NETWORK_NETWORK_SET_COMMUNICATION_GROUP_FLAGS_);
		NETWORK.set_function("NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE_", LUA_NATIVE_NETWORK_NETWORK_HAS_PLAYER_PASSED_CHECK_TYPE_);
		...
		NETWORK.set_function("NETWORK_CAN_TEXT_FROM_GAMER_BE_VIEWED_", LUA_NATIVE_NETWORK_NETWORK_CAN_TEXT_FROM_GAMER_BE_VIEWED_);
		...
		NETWORK.set_function("NETWORK_SET_TUTORIAL_SPECIAL_SESSION_", LUA_NATIVE_NETWORK_NETWORK_SET_TUTORIAL_SPECIAL_SESSION_);
		NETWORK.set_function("NETWORK_IS_SPECIAL_TUTORIAL_SESSION_", LUA_NATIVE_NETWORK_NETWORK_IS_SPECIAL_TUTORIAL_SESSION_);
		...
		NETWORK.set_function("NETWORK_HIDE_ENTITY_IN_TUTORIAL_SESSION_", LUA_NATIVE_NETWORK_NETWORK_HIDE_ENTITY_IN_TUTORIAL_SESSION_);
		...
		NETWORK.set_function("SET_FREEMODE_REPORT_DATA_", LUA_NATIVE_NETWORK_SET_FREEMODE_REPORT_DATA_);
		...
		NETWORK.set_function("NETWORK_CLEAR_CLOCK_SYNC_TIME_OVERRIDE_", LUA_NATIVE_NETWORK_NETWORK_CLEAR_CLOCK_SYNC_TIME_OVERRIDE_);
		NETWORK.set_function("NETWORK_SYNC_CLOCK_TIME_OVERRIDE", LUA_NATIVE_NETWORK_NETWORK_SYNC_CLOCK_TIME_OVERRIDE);
		...
		NETWORK.set_function("NETWORK_SET_TUNABLES_REGISTRATION_CONTEXTS_", LUA_NATIVE_NETWORK_NETWORK_SET_TUNABLES_REGISTRATION_CONTEXTS_);
		NETWORK.set_function("NETWORK_CLEAR_TUNABLES_REGISTRATION_CONTEXTS_", LUA_NATIVE_NETWORK_NETWORK_CLEAR_TUNABLES_REGISTRATION_CONTEXTS_);
		NETWORK.set_function("NETWORK_GET_TUNABLES_REGISTRATION_BOOL_", LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_BOOL_);
		NETWORK.set_function("NETWORK_GET_TUNABLES_REGISTRATION_INT_", LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_INT_);
		NETWORK.set_function("NETWORK_GET_TUNABLES_REGISTRATION_FLOAT_", LUA_NATIVE_NETWORK_NETWORK_GET_TUNABLES_REGISTRATION_FLOAT_);
		...
		NETWORK.set_function("NETWORK_TRIGGER_DAMAGE_EVENT_FOR_ZERO_PED_DAMAGE_", LUA_NATIVE_NETWORK_NETWORK_TRIGGER_DAMAGE_EVENT_FOR_ZERO_PED_DAMAGE_);
		...
		NETWORK.set_function("NETWORK_SET_IGNORE_VEHICLE_RAMMED_BY_NON_VEHICLE_", LUA_NATIVE_NETWORK_NETWORK_SET_IGNORE_VEHICLE_RAMMED_BY_NON_VEHICLE_);
		...
		NETWORK.set_function("UGC_GET_CONTENT_DESCRIPTION", LUA_NATIVE_NETWORK_UGC_GET_CONTENT_DESCRIPTION);
		...
		NETWORK.set_function("NETWORK_HAS_ROS_PRIVILEGE_REPORTING_", LUA_NATIVE_NETWORK_NETWORK_HAS_ROS_PRIVILEGE_REPORTING_);
		...
		NETWORK.set_function("NETWORK_GET_DUMP_OF_ASSET_VERIFIER_", LUA_NATIVE_NETWORK_NETWORK_GET_DUMP_OF_ASSET_VERIFIER_);
		...
		NETWORK.set_function("NETWORK_HAS_SC_MEMBERSHIP", LUA_NATIVE_NETWORK_NETWORK_HAS_SC_MEMBERSHIP);
		NETWORK.set_function("NETWORK_UGC_NAV", LUA_NATIVE_NETWORK_NETWORK_UGC_NAV);
		NETWORK.set_function("NETWORK_GET_GAME_RESTART_REASON_", LUA_NATIVE_NETWORK_NETWORK_GET_GAME_RESTART_REASON_);
		NETWORK.set_function("NETWORK_CONFIRM_GAME_RESTART_", LUA_NATIVE_NETWORK_NETWORK_CONFIRM_GAME_RESTART_);
		NETWORK.set_function("NETWORK_GET_GAME_RESTART_REASON_MESSAGE_LABEL_", LUA_NATIVE_NETWORK_NETWORK_GET_GAME_RESTART_REASON_MESSAGE_LABEL_);
		NETWORK.set_function("NETWORK_GET_BATTLEYE_ERROR_MESSAGE_LABEL_", LUA_NATIVE_NETWORK_NETWORK_GET_BATTLEYE_ERROR_MESSAGE_LABEL_);
	}
}
