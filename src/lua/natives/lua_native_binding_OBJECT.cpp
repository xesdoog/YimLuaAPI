...
namespace lua::native
{
	...
	static void LUA_NATIVE_OBJECT_SET_OBJECT_TARGETTABLE_BY_PLAYER_(Object object, bool setFlag34, bool setFlag35)
	{
		OBJECT::_SET_OBJECT_TARGETTABLE_BY_PLAYER(object, setFlag34, setFlag35);
	}
	...
	static bool LUA_NATIVE_OBJECT_DOOR_SYSTEM_GET_IS_SPRING_REMOVED(Hash doorHash)
	{
		auto retval = (bool)OBJECT::DOOR_SYSTEM_GET_IS_SPRING_REMOVED(doorHash);
		return retval;
	}
	...
	static void LUA_NATIVE_OBJECT_SET_PICKUP_GLOW_DISABLED_(Pickup pickup, bool toggle)
	{
		OBJECT::_SET_PICKUP_GLOW_DISABLED(pickup, toggle);
	}
	...
	void init_native_binding_OBJECT(sol::state& L)
	{
		...
		OBJECT.set_function("SET_OBJECT_TARGETTABLE_BY_PLAYER_", LUA_NATIVE_OBJECT_SET_OBJECT_TARGETTABLE_BY_PLAYER_);
		...
		OBJECT.set_function("DOOR_SYSTEM_GET_IS_SPRING_REMOVED", LUA_NATIVE_OBJECT_DOOR_SYSTEM_GET_IS_SPRING_REMOVED);
		...
		OBJECT.set_function("SET_PICKUP_GLOW_DISABLED_", LUA_NATIVE_OBJECT_SET_PICKUP_GLOW_DISABLED_);
