...
namespace lua::native
{
	...
	static void LUA_NATIVE_PED_SET_BLOCK_AMBIENT_PEDS_FROM_DROPPING_WEAPONS_THIS_FRAME_()
	{
		PED::_SET_BLOCK_AMBIENT_PEDS_FROM_DROPPING_WEAPONS_THIS_FRAME();
	}
	...
	static bool LUA_NATIVE_PED_SET_PED_SURVIVES_BEING_OUT_OF_WATER_(Ped ped, bool toggle)
	{
		auto retval = (bool)PED::_SET_PED_SURVIVES_BEING_OUT_OF_WATER(ped, toggle);
		return retval;
	}
	...
	static void LUA_NATIVE_PED_SET_PED_CAN_BODY_RECOIL_IK(Ped ped, bool toggle)
	{
		PED::SET_PED_CAN_BODY_RECOIL_IK(ped, toggle);
	}
	...
	void init_native_binding_PED(sol::state& L)
	{
		...
		PED.set_function("SET_BLOCK_AMBIENT_PEDS_FROM_DROPPING_WEAPONS_THIS_FRAME_", LUA_NATIVE_PED_SET_BLOCK_AMBIENT_PEDS_FROM_DROPPING_WEAPONS_THIS_FRAME_);
		...
		PED.set_function("SET_PED_SURVIVES_BEING_OUT_OF_WATER_", LUA_NATIVE_PED_SET_PED_SURVIVES_BEING_OUT_OF_WATER_);
		...
		PED.set_function("SET_PED_CAN_BODY_RECOIL_IK", LUA_NATIVE_PED_SET_PED_CAN_BODY_RECOIL_IK);
