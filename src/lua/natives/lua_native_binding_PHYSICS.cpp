...
namespace lua::native
{
	...
	static Vector3 LUA_NATIVE_PHYSICS_GET_DAMPING(Entity entity, int type)
	{
		auto retval = PHYSICS::GET_DAMPING(entity, type);
		return retval;
	}
	...
	void init_native_binding_PHYSICS(sol::state& L)
	{
		...
		PHYSICS.set_function("GET_DAMPING", LUA_NATIVE_PHYSICS_GET_DAMPING);
