...
namespace lua::native
{
	...
	static void LUA_NATIVE_SOCIALCLUB_SC_EMAIL_MARKETING_EMAIL_OPENED_(int index, Hash type)
	{
		SOCIALCLUB::_SC_EMAIL_MARKETING_EMAIL_OPENED(index, type);
	}
	...
	static std::tuple<bool, char> LUA_NATIVE_SOCIALCLUB_SC_PROFANITY_GET_PROFANE_WORD(int token, char outProfaneWord)
	{
		std::tuple<bool, char> return_values;
		std::get<0>(return_values) = (bool)SOCIALCLUB::SC_PROFANITY_GET_PROFANE_WORD(token, &outProfaneWord);
		std::get<1>(return_values) = outProfaneWord;
	...
	void init_native_binding_SOCIALCLUB(sol::state& L)
	{
		...
		SOCIALCLUB.set_function("SC_EMAIL_MARKETING_EMAIL_OPENED_", LUA_NATIVE_SOCIALCLUB_SC_EMAIL_MARKETING_EMAIL_OPENED_);
		...
		SOCIALCLUB.set_function("SC_PROFANITY_GET_PROFANE_WORD", LUA_NATIVE_SOCIALCLUB_SC_PROFANITY_GET_PROFANE_WORD);
