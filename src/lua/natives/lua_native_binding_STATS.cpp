...
namespace lua::native
{
	...
	static void LUA_NATIVE_STATS_PLAYSTATS_FLOW_HIGH_(float posX, float posY, float posZ, sol::stack_object action, bool p4, int p5)
	{
		STATS::_PLAYSTATS_FLOW_HIGH(posX, posY, posZ, action.is<const char*>() ? action.as<const char*>() : nullptr, p4, p5);
	}
	...
	static void LUA_NATIVE_STATS_PLAYSTATS_MASTER_CONTROL(Any p0, Any p1, Any p2, Any p3, Any p4)
	{
		STATS::PLAYSTATS_MASTER_CONTROL(p0, p1, p2, p3, p4);
	}
	...
	static void LUA_NATIVE_STATS_PLAYSTATS_DEATH_INFO_(Ped victimPed, Ped killerPed, int mentalState, bool revengeKill, int victimKvK, int killerKvK)
	{
		STATS::_PLAYSTATS_DEATH_INFO(victimPed, killerPed, mentalState, revengeKill, victimKvK, killerKvK);
	}
	...
	static void LUA_NATIVE_STATS_PLAYSTATS_INIT_MULTIPLAYER_(Any p0, Any p1, Any p2)
	{
		STATS::_PLAYSTATS_INIT_MULTIPLAYER(p0, p1, p2);
	}
	...
	static void LUA_NATIVE_STATS_PLAYSTATS_SCRIPT_EVENT_FPOM_(uintptr_t data)
	{
		STATS::_PLAYSTATS_SCRIPT_EVENT_FPOM((Any*)data);
	}

	static void LUA_NATIVE_STATS_PLAYSTATS_LOBBY_EXIT_(uintptr_t p0)
	{
		STATS::_PLAYSTATS_LOBBY_EXIT((Any*)p0);
	}

	static void LUA_NATIVE_STATS_PLAYSTATS_LOBBY_STARTED_(uintptr_t p0)
	{
		STATS::_PLAYSTATS_LOBBY_STARTED((Any*)p0);
	}

	static void LUA_NATIVE_STATS_PLAYSTATS_CREATOR_END_(uintptr_t p0)
	{
		STATS::_PLAYSTATS_CREATOR_END((Any*)p0);
	}
	...
	void init_native_binding_STATS(sol::state& L)
	{
		...
		STATS.set_function("PLAYSTATS_FLOW_HIGH_", LUA_NATIVE_STATS_PLAYSTATS_FLOW_HIGH_);
		...
		STATS.set_function("PLAYSTATS_DEATH_INFO_", LUA_NATIVE_STATS_PLAYSTATS_DEATH_INFO_);
		...
		STATS.set_function("PLAYSTATS_INIT_MULTIPLAYER_", LUA_NATIVE_STATS_PLAYSTATS_INIT_MULTIPLAYER_);
		...
		STATS.set_function("PLAYSTATS_SCRIPT_EVENT_FPOM_", LUA_NATIVE_STATS_PLAYSTATS_SCRIPT_EVENT_FPOM_);
		STATS.set_function("PLAYSTATS_LOBBY_EXIT_", LUA_NATIVE_STATS_PLAYSTATS_LOBBY_EXIT_);
		STATS.set_function("PLAYSTATS_LOBBY_STARTED_", LUA_NATIVE_STATS_PLAYSTATS_LOBBY_STARTED_);
		STATS.set_function("PLAYSTATS_CREATOR_END_", LUA_NATIVE_STATS_PLAYSTATS_CREATOR_END_);
	}
}
