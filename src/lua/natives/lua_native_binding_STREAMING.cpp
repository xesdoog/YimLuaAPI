...
namespace lua::native
{
	...
	static float LUA_NATIVE_STREAMING_GET_MODEL_ADDITIONAL_COST_(Hash modelHash)
	{
		auto retval = STREAMING::_GET_MODEL_ADDITIONAL_COST(modelHash);
		return retval;
	}

	static float LUA_NATIVE_STREAMING_GET_TOTAL_MODEL_COST_(Hash modelHash)
	{
		auto retval = STREAMING::_GET_TOTAL_MODEL_COST(modelHash);
		return retval;
	}
	...
	static void LUA_NATIVE_STREAMING_SET_SPHERICAL_STREAM_DISTANT_HILODS_THIS_FRAME_()
	{
		STREAMING::_SET_SPHERICAL_STREAM_DISTANT_HILODS_THIS_FRAME();
	}
	...
	void init_native_binding_STREAMING(sol::state& L)
	{
		...
		STREAMING.set_function("GET_MODEL_ADDITIONAL_COST_", LUA_NATIVE_STREAMING_GET_MODEL_ADDITIONAL_COST_);
		STREAMING.set_function("GET_TOTAL_MODEL_COST_", LUA_NATIVE_STREAMING_GET_TOTAL_MODEL_COST_);
		STREAMING.set_function("SET_ISLAND_ENABLED", LUA_NATIVE_STREAMING_SET_ISLAND_ENABLED);
		STREAMING.set_function("SET_SPHERICAL_STREAM_DISTANT_HILODS_THIS_FRAME_", LUA_NATIVE_STREAMING_SET_SPHERICAL_STREAM_DISTANT_HILODS_THIS_FRAME_);
	}
}
