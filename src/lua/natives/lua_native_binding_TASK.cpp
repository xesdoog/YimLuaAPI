...
namespace lua::native
{
	...
	static void LUA_NATIVE_TASK_TASK_ENTER_VEHICLE(Ped ped, Vehicle vehicle, int timeout, int seat, float speed, int flag, sol::stack_object overrideEntryClipsetName)
	{
		TASK::TASK_ENTER_VEHICLE(ped, vehicle, timeout, seat, speed, flag, overrideEntryClipsetName.is<const char*>() ? overrideEntryClipsetName.as<const char*>() : nullptr);
	}
	...
	static void LUA_NATIVE_TASK_TASK_SHARK_CIRCLE_COORD(Ped ped, float x, float y, float z, float moveBlendRatio, float radius)
	{
		TASK::TASK_SHARK_CIRCLE_COORD(ped, x, y, z, moveBlendRatio, radius);
	}
	...
	static void LUA_NATIVE_TASK_SET_SEQUENCE_PREVENT_MIGRATION(int taskSequenceId)
	{
		TASK::SET_SEQUENCE_PREVENT_MIGRATION(taskSequenceId);
	}
	...
	static void LUA_NATIVE_TASK_CLEAR_PED_SCRIPT_TASK_IF_RUNNING_THREAT_RESPONSE_NON_TEMP_TASK(Ped ped)
	{
		TASK::CLEAR_PED_SCRIPT_TASK_IF_RUNNING_THREAT_RESPONSE_NON_TEMP_TASK(ped);
	}
	...
	static void LUA_NATIVE_TASK_SET_DRIVE_TASK_MAX_CRUISE_SPEED(Ped ped, float speed, bool updateBaseTask)
	{
		TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(ped, speed, updateBaseTask);
	}
	...
	static void LUA_NATIVE_TASK_SET_PED_WAYPOINT_PROGRESS(Ped ped, int progress)
	{
		TASK::SET_PED_WAYPOINT_PROGRESS(ped, progress);
	}
	...
	static bool LUA_NATIVE_TASK_VEHICLE_WAYPOINT_PLAYBACK_GET_IS_PAUSED(Vehicle vehicle)
	{
		auto retval = (bool)TASK::VEHICLE_WAYPOINT_PLAYBACK_GET_IS_PAUSED(vehicle);
		return retval;
	}
	...
	static void LUA_NATIVE_TASK_SET_AMBIENT_PED_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED_(Ped ped, bool enable)
	{
		TASK::_SET_AMBIENT_PED_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED(ped, enable);
	}
	...
	void init_native_binding_TASK(sol::state& L)
	{
		...
		TASK.set_function("TASK_SHARK_CIRCLE_COORD", LUA_NATIVE_TASK_TASK_SHARK_CIRCLE_COORD);
		...
		TASK.set_function("SET_SEQUENCE_PREVENT_MIGRATION", LUA_NATIVE_TASK_SET_SEQUENCE_PREVENT_MIGRATION);
		...
		TASK.set_function("CLEAR_PED_SCRIPT_TASK_IF_RUNNING_THREAT_RESPONSE_NON_TEMP_TASK", LUA_NATIVE_TASK_CLEAR_PED_SCRIPT_TASK_IF_RUNNING_THREAT_RESPONSE_NON_TEMP_TASK);
		...
		TASK.set_function("SET_PED_WAYPOINT_PROGRESS", LUA_NATIVE_TASK_SET_PED_WAYPOINT_PROGRESS);
		...
		TASK.set_function("SET_AMBIENT_PED_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED_", LUA_NATIVE_TASK_SET_AMBIENT_PED_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED_);
