...
namespace lua::native
{
	...
	static bool LUA_NATIVE_VEHICLE_GET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED_(Vehicle vehicle)
	{
		auto retval = (bool)VEHICLE::_GET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED(vehicle);
		return retval;
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_PLANE_AVOIDS_OTHERS_(Vehicle vehicle, bool toggle)
	{
		VEHICLE::_SET_PLANE_AVOIDS_OTHERS(vehicle, toggle);
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_MAKE_TRAIN_SCAN_FOR_BLOCKING_ENTITIES_(Vehicle train, bool toggle)
	{
		VEHICLE::_SET_MAKE_TRAIN_SCAN_FOR_BLOCKING_ENTITIES(train, toggle);
	}

	static int LUA_NATIVE_VEHICLE_GET_MISSION_TRAIN_CONFIG_INDEX_BY_NAME_(sol::stack_object name)
	{
		auto retval = VEHICLE::_GET_MISSION_TRAIN_CONFIG_INDEX_BY_NAME(name.is<const char*>() ? name.as<const char*>() : nullptr);
		return retval;
	}
	...
	static bool LUA_NATIVE_VEHICLE_GET_IS_VEHICLE_ELECTRIC_(Hash vehicleModel)
	{
		auto retval = (bool)VEHICLE::_GET_IS_VEHICLE_ELECTRIC(vehicleModel);
		return retval;
	}

	static int LUA_NATIVE_VEHICLE_GET_VEHICLE_DRIVETRAIN_TYPE_(Hash vehicleModel)
	{
		auto retval = VEHICLE::_GET_VEHICLE_DRIVETRAIN_TYPE(vehicleModel);
		return retval;
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_VEHICLE_TAIL_BROKEN(Vehicle vehicle, bool toggle)
	{
		VEHICLE::SET_VEHICLE_TAIL_BROKEN(vehicle, toggle);
	}
	...
	static void LUA_NATIVE_VEHICLE_ENABLE_INDIVIDUAL_PLANE_PROPELLER_(Vehicle vehicle, int propeller)
	{
		VEHICLE::_ENABLE_INDIVIDUAL_PLANE_PROPELLER(vehicle, propeller);
	}
	...
	static Any LUA_NATIVE_VEHICLE_SET_VEHICLE_EXPLOSIVE_DAMAGE_SCALE_(Vehicle vehicle, float scale)
	{
		auto retval = VEHICLE::_SET_VEHICLE_EXPLOSIVE_DAMAGE_SCALE(vehicle, scale);
		return retval;
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_DISABLE_HELI_EXPLODE_FROM_BODY_DAMAGE(Vehicle vehicle, bool disable)
	{
		VEHICLE::SET_DISABLE_HELI_EXPLODE_FROM_BODY_DAMAGE(vehicle, disable);
	}

	static void LUA_NATIVE_VEHICLE_SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_ON_COLLISION(Vehicle vehicle, bool disable)
	{
		VEHICLE::SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_ON_COLLISION(vehicle, disable);
	}

	static void LUA_NATIVE_VEHICLE_SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_RECEIVED_BY_AI_VEHICLE_(Vehicle vehicle, bool disable)
	{
		VEHICLE::_SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_RECEIVED_BY_AI_VEHICLE(vehicle, disable);
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_PLANE_CONTROL_SECTIONS_SHOULD_BREAK_OFF_FROM_EXPLOSIONS(Vehicle vehicle, bool toggle)
	{
		VEHICLE::SET_PLANE_CONTROL_SECTIONS_SHOULD_BREAK_OFF_FROM_EXPLOSIONS(vehicle, toggle);
	}
	...
	static bool LUA_NATIVE_VEHICLE_IS_VEHICLE_ON_BOOST_PAD_(Vehicle vehicle)
	{
		auto retval = (bool)VEHICLE::_IS_VEHICLE_ON_BOOST_PAD(vehicle);
		return retval;
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_NITROUS_IS_VISIBLE_(Vehicle vehicle, bool enabled)
	{
		VEHICLE::_SET_NITROUS_IS_VISIBLE(vehicle, enabled);
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_REMAINING_NITROUS_DURATION_(Vehicle vehicle, float duration)
	{
		VEHICLE::_SET_REMAINING_NITROUS_DURATION(vehicle, duration);
	}
	...
	static void LUA_NATIVE_VEHICLE_SET_NITROUS_IS_ACTIVE(Vehicle vehicle, bool toggle)
	{
		VEHICLE::SET_NITROUS_IS_ACTIVE(vehicle, toggle);
	}
	...
	void init_native_binding_VEHICLE(sol::state& L)
	{
		...
		VEHICLE.set_function("GET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED_", LUA_NATIVE_VEHICLE_GET_VEHICLE_ALLOW_HOMING_MISSLE_LOCKON_SYNCED_);
		...
		VEHICLE.set_function("SET_PLANE_AVOIDS_OTHERS_", LUA_NATIVE_VEHICLE_SET_PLANE_AVOIDS_OTHERS_);
		...
		VEHICLE.set_function("SET_MAKE_TRAIN_SCAN_FOR_BLOCKING_ENTITIES_", LUA_NATIVE_VEHICLE_SET_MAKE_TRAIN_SCAN_FOR_BLOCKING_ENTITIES_);
		VEHICLE.set_function("GET_MISSION_TRAIN_CONFIG_INDEX_BY_NAME_", LUA_NATIVE_VEHICLE_GET_MISSION_TRAIN_CONFIG_INDEX_BY_NAME_);
		...
		VEHICLE.set_function("GET_IS_VEHICLE_ELECTRIC_", LUA_NATIVE_VEHICLE_GET_IS_VEHICLE_ELECTRIC_);
		VEHICLE.set_function("GET_VEHICLE_DRIVETRAIN_TYPE_", LUA_NATIVE_VEHICLE_GET_VEHICLE_DRIVETRAIN_TYPE_);
		...
		VEHICLE.set_function("SET_VEHICLE_TAIL_BROKEN", LUA_NATIVE_VEHICLE_SET_VEHICLE_TAIL_BROKEN);
		...
		VEHICLE.set_function("ENABLE_INDIVIDUAL_PLANE_PROPELLER_", LUA_NATIVE_VEHICLE_ENABLE_INDIVIDUAL_PLANE_PROPELLER_);
		...
		VEHICLE.set_function("SET_VEHICLE_EXPLOSIVE_DAMAGE_SCALE_", LUA_NATIVE_VEHICLE_SET_VEHICLE_EXPLOSIVE_DAMAGE_SCALE_);
		...
		VEHICLE.set_function("SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_RECEIVED_BY_AI_VEHICLE_", LUA_NATIVE_VEHICLE_SET_DISABLE_EXPLODE_FROM_BODY_DAMAGE_RECEIVED_BY_AI_VEHICLE_);
		...
		VEHICLE.set_function("SET_PLANE_CONTROL_SECTIONS_SHOULD_BREAK_OFF_FROM_EXPLOSIONS", LUA_NATIVE_VEHICLE_SET_PLANE_CONTROL_SECTIONS_SHOULD_BREAK_OFF_FROM_EXPLOSIONS);
		...
		VEHICLE.set_function("IS_VEHICLE_ON_BOOST_PAD_", LUA_NATIVE_VEHICLE_IS_VEHICLE_ON_BOOST_PAD_);
		...
		VEHICLE.set_function("SET_NITROUS_IS_VISIBLE_", LUA_NATIVE_VEHICLE_SET_NITROUS_IS_VISIBLE_);
		...
		VEHICLE.set_function("SET_REMAINING_NITROUS_DURATION_", LUA_NATIVE_VEHICLE_SET_REMAINING_NITROUS_DURATION_);
