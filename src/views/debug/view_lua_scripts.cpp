...
namespace big
{
	...
	void view::lua_scripts()
	{
		...
		ImGui::BeginGroup();
		ImGui::Text("Enabled Lua Scripts:");
		{
		...
		ImGui::SameLine();
		ImGui::BeginGroup();
		ImGui::Text("Disabled Lua Scripts:");
		{
		...
		if (!selected_module.expired())
		{
			...
			ImGui::Text("Script Patches Registered: %zu", selected_module.lock()->m_registered_script_patches.size());
